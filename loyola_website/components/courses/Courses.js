...
const TextComponent = ()=>{
  return(
    <div>
      <h1 className='text-3xl font-bold pb-8  drop-shadow-xl  text-white'>
        <span>Our curriculum offers a brilliant set of degree programs in </span></h1>
        <p className=' text-center text-5xl text-white tracking-widest border-b-2 py-8 drop-shadow-xl'>ARTS AND COMMERCE</p>
    </div>
  )
}
