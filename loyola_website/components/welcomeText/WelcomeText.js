  ...
  return (
    <>
      ...
      <div className="welcometext">
        ...
        Commerce and Arts streams. After several years of discernments and
        discussions the Jesuits of Karnataka Jesuit Province finally decided to
        start a degree College in the name of their Founder, St Ignatius Loyola.
        The Loyola Degree College started functioning from the academic year
        2017-18 with B. Com and BA (Journalism,Communicative Englishand
        Psychology) courses. The College is affiliated to Bangalore University.
        The College is a unit of BANGLORE JESUIT EDUCATIONAL SOCIETY, Jesuit
        Nivas, Museum Road, Bengaluru-560025. The Campus has a spacious
        building, a large playground with facilities for cricket, basketball,
        volley ball and other sports and games.
      </div>
    </>
  );
};
