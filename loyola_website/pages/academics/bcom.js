  ...
  return (
    ...
    >
      ...
      <p className={`mt-6 ${bodyText.className}`}>
        B.Com or Bachelor of Commerce is an undergraduate 4-year full time
        degree program that provides educational expertise in the commerce
        stream.{" "}
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <p className={`mt-2 ${bodyText.className}`}>
        Students who studied commerce as the main subject in 12th standard of
