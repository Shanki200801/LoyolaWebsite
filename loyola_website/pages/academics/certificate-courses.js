...
const Certificate = ()=>{
    return(
        <div className="bg-gradient-to-tr from-violet-200 to-violet-50" >
            ...
            <div id="courses-group" className='grid grid-cols-3 mt-10'>
                ...
                <CertCard courseName="Advanced Excel" className="justify-self-center" src={excelLogo} bgGrad="bg-gradient-to-tr from-violet-700 to-violet-400"/>
            ...
            <h2 className={`flex justify-center pt-10 text-black text-6xl ${kaushanScript.className} mt-16  `}>Study of Languages</h2>
            <div id="grid-container" className='mt-10'>
              <div className={`grid grid-cols-3`}>
                <LangCard lang="English" className="justify-self-end" src={smallA} bgGrad="bg-gradient-to-tr from-blue-700 to-blue-500"/>
                <LangCard lang="Kannada" className="justify-self-center" src={kannada} bgGrad="bg-gradient-to-tr from-cyan-600 to-cyan-400"/>
                <LangCard lang="Hindi" className="justify-self-start" src={hindi} bgGrad="bg-gradient-to-tr from-blue-700 to-blue-500"/>
              </div>
              <div className={`grid grid-cols-2 gap-48 mt-10`}>
                <LangCard lang="Tamil" className="justify-self-end" src={tamil} bgGrad="bg-gradient-to-tr from-cyan-600 to-cyan-400"/>
                <LangCard lang="Telugu" className="justify-self-start" src={telugu} bgGrad="bg-gradient-to-tr from-cyan-600 to-cyan-400"/>
              </div>  
            </div>
            ...
            <div class="absolute inset-0 transform hover:skew-y-12 transition duration-300">
                ...
                <div className={`absolute inset-0 h-full w-full rounded-xl ${props.bgGrad} px-12 text-center text-slate-200`}>
                  ...
                  <Image className="w-auto h-3/5" src={props.src}/>
                    <h1 className={`text-4xl mt-2 text-black font-bold ${novaCut.className}`}>{props.lang}</h1>
                  </div>
                </div>
                </div>
            </div>
