...
const Admissions = () => {
    ...
    return ( 
        <div className='bg-white text-black'>
          ...
          <EligibilitySub/>
          <div className={`hidden lg:grid lg:grid-cols-2 lg:px-32 lg:mt-20 lg:gap-10`}>
            <Image src={admissionsImg} className='lg:w-auto lg:h-full lg:object-cover'/>
            <GenInstructionsSub/>
          </div>
          <div className={`lg:hidden`}>
            <Image src={admissionsImg} className='mt-10'/>
            <GenInstructionsSub className="mt-10 px-8"/>
          </div>
          <Image src={scholarshipImg} className='mt-10 lg:hidden' />
              <ScholarshipInstructionsSub/>
              <div className={`flex justify-center p-10`}>
                <Button variant="contained" href="/admissions/form" size="large" className={`text-xl lg:text-3xl lg:p-5 ${subheading.className}`}>
                  Apply Now!
                </Button>
              </div>
...
const EligibilitySub = ()=>{
  return (
    <section className={`mt-10 px-6 lg:mt-16 lg:px-32`}>
...
const GenInstructionsSub = (props)=>{
  return(
    <section className={`${props.className}`}>
      <h2 className={` ${subheading.className} text-2xl lg:text-4xl underline underline-offset-8`}>GENERAL INSTRUCTIONS</h2>
...
const ScholarshipInstructionsSub = ()=>{
  return (
    <section className={`mt-10 p-6 lg:mt-20 lg:px-32 lg:grid lg:justify-center`}>
      <h2 className={`${subheading.className} text-2xl text-center lg:text-4xl underline underline-offset-8 lg:flex lg:justify-center`}>ADMISSION SCHOLARSHIP INSTRUCTIONS</h2>
              <table className={`mt-10`}>
                <thead>
                  <tr >
                    <th className='border-2 border-black p-3'>Criteria</th>
                    <th className='border-2 border-black p-3'>Scholarship</th>
                  </tr>
                </thead>
                <tbody >
                  <tr>
                    <td className='border-2 border-black p-3'>Within 3 days of the announcement of PUC results</td>
                    <td className='border-2 border-black p-3'>10% of the fees</td>
                    
                  </tr>
                  <tr>
                    <td className='border-2 border-black p-3'>Within 3 days of the announcement of PUC results and above 85% marks</td>
                    <td className='border-2 border-black p-3'>10% + 5% = 15% of the fees</td>
                    
                  </tr>
                  <tr>
                    <td className='border-2 border-black p-3'>Within 3 days of the announcement of PUC results and above 95% marks</td>
                    <td className='border-2 border-black p-3'>10% + 15% = 25% of the fees</td>
                  </tr>
                </tbody>
              </table>
    </section>
