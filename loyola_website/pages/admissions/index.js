...
import { Allerta_Stencil, Inter, Oswald, Lobster_Two } from "next/font/google";
...
const Admissions = () => {
  return (
    <div className=" text-black bg-emerald-100">
      <h1
        className={`${lobster.className} text-shadow-sm-green flex justify-center md:text-6xl min-[320px]:text-5xl pt-8`}
      >
        Admissions
      </h1>
      <EligibilitySub />
      <div
        className={`hidden lg:grid lg:grid-cols-2 lg:px-10 lg:mt-5 lg:gap-10 lg:py-10 lg:mx-32 bg-gradient-to-br from-amber-300 to-green-300 rounded-tr-sm rounded-bl-sm rounded-tl-md rounded-br-md`}
      >
        <Image
          src={admissionsImg}
      ...
      <div className={`flex justify-center p-10`}>
        <Button
          ...
          size="large"
          className={`text-xl lg:text-3xl lg:p-5 ${subheading.className} bg-gradient-to-br from-blue-500 to-cyan-300 hover:from-blue-300 hover:to-cyan-500`}
        >
          Apply Now!
        </Button>
      </div>
...
const EligibilitySub = () => {
  return (
    <section
      className={`mt-10 px-6 lg:mt-12 lg:mx-32 lg:px-10 py-10 bg-gradient-to-tl from-emerald-600 to-yellow-300 text-white rounded-tr-md rounded-bl-md rounded-tl-sm rounded-br-sm`}
    >
      <h2
        className={`${subheading.className} tracking-tight text-2xl lg:text-4xl underline underline-offset-8`}
      >
        ELIGIBILITY
      </h2>
      <div
        className={` ${bodyText.className} tracking-tight mt-5 lg:mt-10 lg:text-xl`}
      >
...
const GenInstructionsSub = (props) => {
  return (
    <section className={`${props.className} `}>
      ...
      <ol className={`${bodyText.className} tracking-tight list-decimal  mt-5`}>
...
const ScholarshipInstructionsSub = () => {
  return (
    <section
      className={`p-6 lg:mt-5 lg:px-32 lg:mx-32 lg:grid lg:justify-center bg-gradient-to-tl from-emerald-600 to-yellow-300 text-white rounded-tr-md rounded-bl-md rounded-tl-sm rounded-br-sm`}
    >
      <h2
      ...
      <table className={`font-medium ${bodyText.className} tracking-tight mt-10`}>
        <thead>
          <tr>
