...
const ScholarshipInstructionsSub = ()=>{
  return (
    <section className={` p-6 lg:mt-5 lg:px-32 lg:mx-32 lg:grid lg:justify-center bg-gradient-to-tl from-emerald-800 to-emerald-600 text-white`}>
      <h2 className={`${subheading.className} text-2xl text-center lg:text-4xl underline underline-offset-8 lg:flex lg:justify-center`}>ADMISSION SCHOLARSHIP INSTRUCTIONS</h2>
              <table className={`mt-10`}>
                ...
                <tbody >
                  <tr>
                    <td className='border-2 border-white p-3'>Within 3 days of the announcement of PUC results</td>
                    <td className='border-2 border-white p-3'>10% of the fees</td>
                    
                  </tr>
                  <tr>
                    <td className='border-2 border-white p-3'>Within 3 days of the announcement of PUC results and above 85% marks</td>
                    <td className='border-2 border-white p-3'>10% + 5% = 15% of the fees</td>
                    
                  </tr>
                  <tr>
                    <td className='border-2 border-white p-3'>Within 3 days of the announcement of PUC results and above 95% marks</td>
                    <td className='border-2 border-white p-3'>10% + 15% = 25% of the fees</td>
                  </tr>
                </tbody>
              </table>
    </section>
