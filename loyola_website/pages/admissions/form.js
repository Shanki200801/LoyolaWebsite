...
const Form = () => {
  ...
  return ( 
        <div className={styles.body}>
            <h1 className={styles.h1}>Admission Form 2023-24</h1>
    <p className={styles.p}>Please fill out this form with the required information</p>
    <form className={styles.form} method="post" action=''>
        <label className={styles.label} for="course">Course
          <select className={styles.select} id="course" name="course" >
    ...
    <fieldset className={styles.fieldset}>
      ...
      <label className={styles.label} for="bg">4. Blood Group
          <select className={styles.select} id="bg" name="bg">
            <option value="">--Select--</option>
      ...
      <label className={styles.label} for="religion">6. Religion
          <select className={styles.select} id="religion" name="religion">
            <option value="">--Select--</option>
      ...
      <fieldset className={styles.fieldset}>
        <label className={styles.label} for="caste">7. Caste <input className={styles.input} id="caste" name="caste" type="text" required /></label><br/>
        <label className={styles.label} for="subcaste"> Subcaste <input id="subcaste" name="subcaste" type="text" required className={styles.input} /></label>
      ...
      <label className={styles.label} for="state"> State
          <select className={styles.select} id="state" name="state">
            <option value="">--Select--</option>
        ...
        <label className={styles.label} for="nri">Are you a NRI/ Foreigner
          <select className={styles.select} id="nri" name="nri">
            <option value="">--Select--</option>
      ...
      <fieldset className={styles.fieldset}>
      <label className={styles.label} for="spab">Are you specially abled?
      ...
      <fieldset className={styles.fieldset}>
      <label className={styles.label} for="bg">11. Name of the Examination Passed
          <select className={styles.select} id="bg" name="qexam">
            <option value="">--Select--</option>
      ...
      <fieldset className={styles.fieldset}>
      <label className={styles.label} for="ymop">12. Year and Month of Passing <input id="ymop" name="ymop" type="text" required className={styles.input} /></label>
      </fieldset>

      <fieldset className={styles.fieldset}>
      <label className={styles.label} for="rnqe">13. Register Number in the Qualifying Examination <input id="rnqe" name="rnqe" type="text" required className={styles.input} /></label>
...
<fieldset className={styles.fieldset}>
    <p>First Language is English. Select your preferred Second Language.</p>
        ...
        <label className={styles.label} for="smob">Aadhar Card Number <input className={styles.input} id="smob" name="aadhaarno" type="text" required /></label><br/>
</fieldset>
        ...
        <label className={styles.label} for="panpan">Parent's Alternate Mobile Number <input className={styles.input} id="pan" name="pan" type="text" required /></label><br/>
        <label className={styles.label} for="pemail">Parent's Email ID (if any) <input className={styles.input} id="pemail" name="pemail" type="email" required /></label><br/> 
        </fieldset>
      ...
      <label className={styles.label} for="osshouse">  House No. <input className={styles.input} id="osshouse" name="osshouse" type="text" required /></label><br/>
      <label className={styles.label} for="ossstreet"> Street <input className={styles.input} id="ossstreet" name="ossstreet" type="text" required /></label><br/>
      <label className={styles.label} for="ossarea"> Area <input className={styles.input} id="ossarea" name="ossarea" type="text" required /></label><br/>
      <label className={styles.label} for="osscity"> Town/City <input className={styles.input} id="osscity" name="osscity" type="text" required /></label><br/>
      <label className={styles.label} for="osspincode"> Pincode <input className={styles.input} id="osspincode" name="osspincode" type="text" required /></label><br/>
      <label className={styles.label} for="ossstate"> State
      <input className={styles.input} id="ossstate" name="ossstate" type="text" required /></label><br/>
      </fieldset>
      ...
      <fieldset className={styles.fieldsetlast}>
        <label className={styles.label} for="gn">21. Guardian Name <input className={styles.input} id="gn" name="gn" type="text" required /></label><br/>
        <label className={styles.label} for="gm">Guardian Mobile No. <input className={styles.input} id="gm" name="gm" type="text" required /></label><br/>
      </fieldset>
