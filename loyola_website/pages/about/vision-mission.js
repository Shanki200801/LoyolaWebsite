...
const Vision = () => {
  return (
    <div className={`flex flex-col gap-3 px-4 justify-center`}>
      ...
      >
        To <span className={`font-medium`}>empower</span> the students to be men and women for others.
      </p>
    </div>
  );
};
  ...
  return (
    <div className={`flex flex-col gap-3 px-4 justify-center`}>
      ...
      <p
        className={`text-m ${generalText.className} tracking-tight pb-4 sm:text-l md:text-l lg:text-l 2xl:text-xl`}
      >
        The educational objective of Loyola Degree College is to <span className={`font-medium`}>prepare</span> men and
        women for the service of the Nation. The College provides students with
        plentiful opportunities to critically understand society and its
...
const VisionMission = () => {
  return (
    <div className={`grid grid-rows-15 bg-red-100 text-black xl:gap-7`}>
      <h1
