...
const ValueBox = ({ valueName, valueHeading, valuePara, boxStyles }) => {
  return (
    <div>
      <li className={`grid grid-cols-10 gap-0 items-center justify-center pl-5`}>
        <h2
    ...
    <div className={`bg-blue-100 text-black`}>
      ...
      <ul className="flex flex-col gap-10 pb-5">
        <ValueBox
          ...
          boxStyles={`border-rose-500 bg-rose-400 shadow-rose-500/50`}
        />
        <ValueBox
          ...
          boxStyles={`border-green-500 bg-green-400 shadow-green-500/50`}
        />
        <ValueBox
          ...
          boxStyles={`border-blue-500 bg-blue-400 shadow-blue-500/50`}
        />
        <ValueBox
          valueName="Action"
          ...
          boxStyles={`border-yellow-300 bg-yellow-200 shadow-yellow-500/50`}
        ...
        <ValueBox
          ...
          boxStyles={`border-purple-500 bg-purple-400 shadow-purple-500/50`}
        />
      </ul>
    </div>
  );
