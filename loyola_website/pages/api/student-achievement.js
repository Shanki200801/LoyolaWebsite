export default function handler(req, res) {
  res.status(200).json([
    ...
    },
    {
      ...
      description: `•	Kusuma S III - BA, Rahul Chettri II - BA, BinouyD’costa, Shan Michael, and Sana Fathima I – BA, bagged the second place for their heart-wrenching documentary ‘Trans Strains’ which focused the life of transgender community Bangalore during pandemic. The documentary is directed by Sana. `,
    },
    {
      id: 5,
