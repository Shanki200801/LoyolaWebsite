        ...
        <div className={`py-3`}>
          ...
          <ul className={`text-m ${inter.className} tracking-tight`}>
            <li className={`pb-2`}>
              ...
              more time studying and there is a higher level of thinking
              demanded. But the college years are also about other kinds of
              learning. Often much of this other learning happens outside of the
              classroom.
            </li>
            <li>
              ...
              college students pass up some of the opportunities that they have
              in college, because they are too focused on either their academic
              life or their party life. Many worry, that getting involved in
              activities or organizations on campus will distract them from
              their academic pursuits rather than enhancing their academics.
            </li>
          </ul>
        </div>
      </section>
