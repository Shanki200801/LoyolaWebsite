...
const StuCouncil = ()=>{
    return (
        <div className='bg-white text-black'>
            <h1 className='flex justify-center text-4xl mt-5'>Student Council</h1>
            <div>
                Student Councils the world over is student-led civic organizations designed to help promote College spirit and leadership among students. 
            </div>
            <table  >
                <tbody>
                <tr>
