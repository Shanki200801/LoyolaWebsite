    ...
    return (
        <div className='bg-white text-black'>
            ...
            <table  >
                ...
                <tr>
                    <td>3rd BCom B</td>
                    <td>Ms Sharal Acquinas</td>
                    <td>Vuice-President</td>
                </tr>
                <tr>
                    <td>2nd  B Com C</td>
                    <td>Mr. Nikhil Teja</td>
                    <td>Secretary</td>
                </tr>
                <tr>
                    <td>1st B Com B</td>
                    <td>Mr. Vivek Kumar Mourya</td>
                    <td>Joint  Secretary</td>
                </tr>
                <tr>
                    <td>2nd B A</td>
                    <td>Mr Shan Michael </td>
