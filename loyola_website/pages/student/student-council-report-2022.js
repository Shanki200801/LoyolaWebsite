...
const SCReport2022 = ()=>{
    return (
        <div className='bg-blue-100 text-black pb-10'>
            <h1 className={`${heading.className} text-center lg:flex lg:justify-center text-4xl pt-5 lg:text-6xl`}>Student Council Election Report 2022</h1>
            <section className={`${bodyText.className} mt-10 mx-5 py-5 px-8 text-justify border-2 border-sky-800 lg:mx-44 lg:text-xl`}>
                <div >
